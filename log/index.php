...
<div id="menu" class="width">
    <ul id="menuli">
        ...
        <li class="active"><a href="<?php echo $ni.'/log';?>"title="Logs"><i class="fa fa-file-text-o"></i> Logs</a></li>
        <li><a href="<?php echo $ni.'/category'; ?>" title="Categories"><i class="fa fa-folder"></i> Categories</a></li>
    </ul>
</div>

<div class="wrapper-pad">
    <h2>Logs</h2>			<div id="table-head">
        <form method="post" action="" name="searchf">
            <input name="search" placeholder="Search..." class="search fleft" type="text">
        </form>
        <img src="../media/img/loader-small.gif" class="fleft loader" width="15px" height="15px">
        <div class="fright">
