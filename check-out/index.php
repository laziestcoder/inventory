...
<div id="menu" class="width">
    <ul id="menuli">
        ...
        <li class="active"><a href="<?php echo $ni.'/check-out';?>" title="Check-Out Item"><i class="fa fa-arrow-up"></i> Check-Out Item</a></li>
...
<div class="wrapper-pad">
    <h2 class="noborder">Check-Out Item</h2>
    <span class="downtitle">Click an item to check-out...</span>
    <div id="table-head">
